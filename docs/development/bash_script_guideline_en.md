In the following you find some bash script best practices.
...
When referencing variables, use curly brackets instead of just $VARIABLE. This standard prevents problems when using bash variables.
