    ...
    templatefile("${path.module}/values.yaml.tftpl",
      {
        ...
        "dogu_registry_password"     = base64decode(var.dogu_registry_password)
        ...
        "docker_registry_password"   = base64decode(var.image_registry_password)
        ...
        "helm_registry_password"     = base64decode(var.helm_registry_password)
