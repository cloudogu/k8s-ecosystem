...
CERTIFICATE_CRT_FILE="${CERTIFICATE_CRT_FILE-.vagrant/certs/k3ces.localdomain.crt}"
CERTIFICATE_KEY_FILE="${CERTIFICATE_KEY_FILE-.vagrant/certs/k3ces.localdomain.key}"
