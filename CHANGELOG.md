...
## [Unreleased]
### Fixed
- [#123] fix wrong component stack name in values template of the ces-core terraform module
...
- Upgrade k9s to v0.50.9
- Upgrade k3s to v1.33.4+k3s1

## [v5.3.0] - 2025-08-26
### Added
- [#118] Add setup timeout variables to ces terraform module
